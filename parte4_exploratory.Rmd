...
O dataset resultante contém `r nevents_outdates` eventos, `r ncases_outdates` cases e 14 variáveis (já mencionadas anteriormente). A comparação de ambos períodos é possível ver abaixo.
...
O dataset resultante contém `r nevents_outresolution` eventos, `r ncases_outresolution` cases e 14 variáveis (já mencionadas anteriormente). A comparação de todos os cortes realizados, olhando a visão tempo de resolução, pode ser analisada abaixo.
...
O dataset resultante contém `r nevents_outmeanactivitys` eventos, `r ncases_outmeanactivitys` cases e 14 variáveis (já mencionadas anteriormente). A comparação com o último o corte realizado, olhando a visão da quantidade eventos, pode ser analisada abaixo.
...
O dataset resultante contém `r nevents_repeatedactivitys` eventos, `r ncases_repeatedactivitys` cases e 14 variáveis (já mencionadas anteriormente). A análise dos eventos removidos, olhando a visão da repetição de atividades em um case, pode ser analisada abaixo.
...
O dataset resultante contém `r nevents_resolutionactivity` eventos, `r ncases_resolutionactivity` cases e 14 variáveis (já mencionadas anteriormente). A análise dos eventos removidos, olhando a visão tempo de resolução da atividade, pode ser analisada abaixo.
...
O dataset resultante contém `r nevents_activitydiffopenclosed` eventos, `r ncases_activitydiffopenclosed` cases e 14 variáveis (já mencionadas anteriormente). A análise dos cases removidos, olhando a visão tempo de resolução, pode ser analisada abaixo.
